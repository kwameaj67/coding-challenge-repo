...
struct Transaction{
    ...
    static let data: [Transaction] = [
        ...
        Transaction(receipient: "Emmanuel Rockson", transaction_status: .sucesss, network: .mtn, price: 500, mobile: 0241234567, transaction_type: .other, comments: "Cool your heart wai", date: "May 23,2022"),
